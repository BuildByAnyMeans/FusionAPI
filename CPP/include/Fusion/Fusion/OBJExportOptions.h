...
# ifdef __COMPILING_ADSK_FUSION_OBJEXPORTOPTIONS_CPP__
# define ADSK_FUSION_OBJEXPORTOPTIONS_API XI_EXPORT
# else
# define ADSK_FUSION_OBJEXPORTOPTIONS_API
# endif
#else
# define ADSK_FUSION_OBJEXPORTOPTIONS_API XI_IMPORT
#endif
...
public:
    ...
    DistanceUnits unitType() const;
    bool unitType(DistanceUnits value);

    ADSK_FUSION_OBJEXPORTOPTIONS_API static const char* classType();
    ADSK_FUSION_OBJEXPORTOPTIONS_API const char* objectType() const override;
    ADSK_FUSION_OBJEXPORTOPTIONS_API void* queryInterface(const char* id) const override;
    ADSK_FUSION_OBJEXPORTOPTIONS_API static const char* interfaceId() { return classType(); }
...
private:
    ...
    virtual DistanceUnits unitType_raw() const = 0;
    virtual bool unitType_raw(DistanceUnits value) = 0;
};

// Inline wrappers

inline bool OBJExportOptions::isOneFilePerBody() const
{
    bool res = isOneFilePerBody_raw();
    return res;
}

inline bool OBJExportOptions::isOneFilePerBody(bool value)
{
    return isOneFilePerBody_raw(value);
}

inline MeshRefinementSettings OBJExportOptions::meshRefinement() const
{
    MeshRefinementSettings res = meshRefinement_raw();
    return res;
}

inline bool OBJExportOptions::meshRefinement(MeshRefinementSettings value)
{
    return meshRefinement_raw(value);
}

inline double OBJExportOptions::surfaceDeviation() const
{
    double res = surfaceDeviation_raw();
    return res;
}

inline bool OBJExportOptions::surfaceDeviation(double value)
{
    return surfaceDeviation_raw(value);
}

inline double OBJExportOptions::normalDeviation() const
{
    double res = normalDeviation_raw();
    return res;
}

inline bool OBJExportOptions::normalDeviation(double value)
{
    return normalDeviation_raw(value);
}

inline double OBJExportOptions::maximumEdgeLength() const
{
    double res = maximumEdgeLength_raw();
    return res;
}

inline bool OBJExportOptions::maximumEdgeLength(double value)
{
    return maximumEdgeLength_raw(value);
}

inline double OBJExportOptions::aspectRatio() const
{
    double res = aspectRatio_raw();
    return res;
}

inline bool OBJExportOptions::aspectRatio(double value)
{
    return aspectRatio_raw(value);
}

inline std::vector<std::string> OBJExportOptions::availablePrintUtilities() const
{
...
inline std::string OBJExportOptions::printUtility() const
{
    std::string res;
...
inline bool OBJExportOptions::printUtility(const std::string& value)
{
    return printUtility_raw(value.c_str());
}

inline bool OBJExportOptions::sendToPrintUtility() const
{
    bool res = sendToPrintUtility_raw();
    return res;
}

inline bool OBJExportOptions::sendToPrintUtility(bool value)
{
    return sendToPrintUtility_raw(value);
}

inline DistanceUnits OBJExportOptions::unitType() const
{
    DistanceUnits res = unitType_raw();
    return res;
}

inline bool OBJExportOptions::unitType(DistanceUnits value)
{
...
#undef ADSK_FUSION_OBJEXPORTOPTIONS_API